  ...
  factory: (require) => {
    ...
    function AgentForm({ initial, isNew, onSave, onCancel, onDelete, models, defaultModel }) {
      ...
      return React.createElement("div", { className: "ad-form" },
        ...
        // v1.5.0：同角色子代理复用策略——编程等渐进任务用 reuse（上下文延续），
        // 探索型角色用 fresh（每次独立新开，避免上下文污染）
        React.createElement("div", { className: "ad-field" },
          ...
          React.createElement("select", {
            ...
            React.createElement("option", { value: "reuse" }, "复用同角色（推荐：同会话内连续任务共用同一子代理，上下文延续；空闲 10 分钟自动回收驻留，下次冷恢复续聊）"),
